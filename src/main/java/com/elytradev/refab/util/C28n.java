...
public class C28n {
    ...
    public static String format(String key, Object... format) {
        return ReFab.proxy.i18nFormat(key, format);
    }

    public static boolean keyExists(String key) {
        return ReFab.proxy.i18nContains(key);
    }

    public static Optional<String> formatOptional(String key, Object... format) {
        return keyExists(key) ? Optional.of(ReFab.proxy.i18nFormat(key, format)) : Optional.absent();
    }

    public static String formatPlural(String key, long amount) {
        PluralRules pr = ReFab.proxy.getPluralRules();
